...
class UsersTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Lastname', 'Password', 'LastLogin', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'lastname', 'password', 'lastLogin', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_LASTNAME, UsersTableMap::COL_PASSWORD, UsersTableMap::COL_LAST_LOGIN, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'lastname', 'password', 'last_login', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Lastname' => 3, 'Password' => 4, 'LastLogin' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'lastname' => 3, 'password' => 4, 'lastLogin' => 5, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_LASTNAME => 3, UsersTableMap::COL_PASSWORD => 4, UsersTableMap::COL_LAST_LOGIN => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'lastname' => 3, 'password' => 4, 'last_login' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('lastname', 'Lastname', 'VARCHAR', true, 80, null);
        $this->addColumn('password', 'Password', 'VARCHAR', true, 72, null);
